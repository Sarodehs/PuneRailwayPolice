...
import Main from "../src/component/chat/Main";
...
import AdminCrimeStaticsForm from "./component/Admin/AdminCrimeStaticsForm";
    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/policerecruitment"
            index
            element={<PoliceRecruitment />}
          />
          ...
          <Route
            path="/medicafacilities"
            index
            element={<MedicaFacilities />}
          />
          ...
          <Route
            path="/beyondcallofduty"
            index
            element={<BeyondCallOfDuty />}
          />
          <Route path="/flash" index element={<Flash />} />
          <Route
            path="/crimeinformation"
            index
            element={<CrimeInformation />}
          />
          ...
          <Route
            path="/touristhelpdesks"
            index
            element={<TouristHelpDesks />}
          />

          <Route path="buddybench" element={<Main socket={socket} />} />
          ...
          <Route path="" element={<PrivateRoute />}>
            ...
            <Route
              path="/adminpositivestory"
              element={<AdminPositiveStory />}
            />
            <Route path="/adminwomenhelpdesk" element={<AdminWomenHelp />} />
            <Route
              path="/adminwomencitytypes"
              element={<AdminWomenCityTypes />}
            />
            <Route
              path="/admincontactofficer"
              element={<AdminContactOfficer />}
            />
            <Route
              path="/admincontactofficedivision"
              element={<AdminContactOfficeDivision />}
            />
            <Route
              path="/adminpolicestation"
            ...
            <Route
              path="/admincrimeinformation"
              element={<AdminCrimeInformation />}
            />
            <Route
              path="/admindailydutychartflash"
              element={<AdminDailyDutyChartFlash />}
            />
            <Route path="/adminmedicalbills" element={<AdminMedicalBills />} />
            <Route
              path="/adminrtirementlist"
              element={<AdminRtirementList />}
            />
            <Route
              path="/adminincrementlist"
              element={<AdminIncrementList />}
            />
            <Route
              path="/admincompassionlist"
              element={<AdminCompassionList />}
            />
            <Route path="/adminrecuirtment" element={<AdminRecuirtment />} />
            <Route path="/adminbmi" element={<AdminBMI />} />
            <Route
              path="/adminpromotionorder"
              element={<AdminPromotionOrder />}
            />
            <Route path="/admincrimestatics" element={<AdminCrimeStatics />} />
            <Route
              path="/admintransferorder"
              element={<AdminTransferOrder />}
            />
            <Route
              path="/admingradationlist"
              element={<AdminGradationList />}
            />
            <Route path="/admingazette" element={<AdminGazette />} />
            <Route
              path="/adminrighttoinformation"
              element={<AdminRightToInformation />}
            />
            <Route
              path="/admininfoprovoidedunderrti"
              element={<AdminInfoProvoidedUnderRTI />}
            />
            <Route
              path="/adminannualadminreport"
              element={<AdminAnnualAdminReport />}
            />
            <Route
              path="/adminimprotantwebsites"
              element={<AdminImprotantWebsites />}
            />
            <Route path="/admincirculars" element={<AdminCirculars />} />
            <Route
              path="/admincitizensalert"
              element={<AdminCitizensAlert />}
            />
            <Route
              path="/adminemergencycontacts"
              element={<AdminEmergencyContacts />}
            />
            <Route path="/adminaddalbumname" element={<AdminAddAlbumName />} />
            <Route
              path="/adminaddphotostoalbum"
              element={<AdminAddPhotosToAlbum />}
            />

            <Route
              path="/adminemergencycontactsform"
              element={<AdminEmergencyContactsForm />}
            />
            <Route path="/adminspsform" element={<AdminSpsForm />} />
            <Route
              path="/adminspsmessageform"
              element={<AdminSpsMessageForm />}
            />
            <Route path="/adminheadlineform" element={<AdminHeadlineForm />} />
            <Route
              path="/adminaddphotostoalbumform"
              element={<AdminAddPhotosToAlbumForm />}
            />
            <Route
              path="/adminaddalbumnameform"
              element={<AdminAddAlbumNameForm />}
            />
            <Route
              path="/Admincircularsform"
              element={<AdminCircularsForm />}
            />
            <Route
              path="/admincitizensalertform"
              element={<AdminCitizensAlertForm />}
            />
            <Route
              path="/adminimprotantwebsitesform"
              element={<AdminImprotantWebsitesForm />}
            />
            <Route path="/admingazetteform" element={<AdminGazetteForm />} />
            <Route
              path="/admingradationlistform"
              element={<AdminGradationListForm />}
            />
            <Route
              path="/adminannualadminreportform"
              element={<AdminAnnualAdminReportForm />}
            />
            <Route
              path="/admininfopprovoidedunderrtiform"
              element={<AdminInfoProvoidedUnderRTIForm />}
            />
            <Route
              path="/adminrighttoinformationform"
              element={<AdminRightToInformationForm />}
            />
            <Route
              path="/admintransferorderform"
              element={<AdminTransferOrderForm />}
            />
            <Route
              path="/adminpromotionorderform"
              element={<AdminPromotionOrderForm />}
            />
            <Route path="/adminbmiform" element={<AdminBMIForm />} />
            <Route
              path="/adminrecuirtmentform"
              element={<AdminRecuirtmentForm />}
            />
            <Route
              path="/admincompassionlistform"
              element={<AdminCompassionListForm />}
            />
            <Route
              path="/adminrtirementlistform"
              element={<AdminRtirementListForm />}
            />
            <Route
              path="/adminincrementlistform"
              element={<AdminIncrementListForm />}
            />
            <Route
              path="/adminmedicalbillsform"
              element={<AdminMedicalBillsForm />}
            />
            <Route
              path="/admindailydutychartflashform"
              element={<AdminDailyDutyChartFlashForm />}
            />
            <Route
              path="/admincrimeinformationform"
              element={<AdminCrimeInformationForm />}
            />
            <Route path="/admintenderform" element={<AdminTenderForm />} />
            <Route
              path="/adminpressreleaseform"
              element={<AdminPressReleaseForm />}
            />
            <Route
              path="/adminsubdivisionform"
              element={<AdminSubDivisionForm />}
            />
            <Route
              path="/adminofficertypeform"
              element={<AdminOfficerTypeForm />}
            />
            <Route path="/adminofficerform" element={<AdminOfficerForm />} />
            <Route
              path="/adminspecialunitform"
              element={<AdminSpecialUnitForm />}
            />
            <Route
              path="/admincontactofficerdivisionform"
              element={<AdminContactOfficerDivisionForm />}
            />
            <Route
              path="/adminpolicestationform"
              element={<AdminPoliceStationForm />}
            />
            <Route
              path="/adminwomencitytypesform"
              element={<AdminWomenCityTypesForm />}
            />
            <Route
              path="/adminwomenhelpdeskform"
              element={<AdminWomenHelpDeskForm />}
            />
            <Route
              path="/adminpositivestoryform"
              element={<AdminPositiveStoryForm />}
            />
            <Route path="/adminuserform" element={<AdminUserForm />} />
            <Route
              path="/admincontactofficerform"
              element={<AdminContactOfficerForm />}
            />
            <Route
              path="/admincrimestaticsform"
              element={<AdminCrimeStaticsForm />}
            />
          </Route>
