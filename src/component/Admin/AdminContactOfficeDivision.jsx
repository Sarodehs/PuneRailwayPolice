...
const AdminContactOfficerDivision = () => {
  ...
  const handleUpdate = (item) => {
    navigate('/admincontactofficerdivisionform', { state: { contactofficerdivisionToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(ContactOfficerDivision.length / rowsToShow);
  ...
  const slicedContactOfficerDivision = ContactOfficerDivision.slice(startIndex, endIndex);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>ContactOfficerDivision </h4></div>
...
export default AdminContactOfficerDivision
