...
const AdminRtirementList = () => {
  ...
  const handleUpdate = (item) => {
    navigate('/adminrtirementlistform', { state: { rtirementlistToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(RtirementList.length / rowsToShow);
  ...
  const slicedRtirementList = RtirementList.slice(startIndex, endIndex);
