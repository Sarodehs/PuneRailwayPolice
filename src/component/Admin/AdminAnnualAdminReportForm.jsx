...
const AdminAnnualAdminReportForm = () => {
  ...
  useEffect(() => {
    if (annualAdminReportToUpdate) {
      setFormData({
        name: annualAdminReportToUpdate.name || '',
        nameinmarathi: annualAdminReportToUpdate.nameinmarathi || '',
        message: annualAdminReportToUpdate.message || '',
        FromDate: annualAdminReportToUpdate.FromDate || '',
        ToDate: annualAdminReportToUpdate.ToDate || '',
      });
    }
        ...
        <div className="row">
          ...
          <div className=" col-md-10 col-xl-10 col-sm-10  justify-content-center pe-0 ps-0" >
            ...
            <div className="row p-3 ">
              ...
              <a href="/adminannualadminreport" className="text-decoration-none text-dark"> <h3 className='m-3'> <span className="material-icons-outlined pe-3 p-2">arrow_back</span>
              Annual Admin Report</h3>
                  </a>
                <hr />
