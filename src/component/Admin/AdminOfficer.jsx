...
const AdminOfficer = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/officer/${id}`, {
        method: 'DELETE',
      });
      if (response.ok) {
  ...
  const handleUpdate = (item) => {
    navigate('/adminofficerform', { state: { officerToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(Officer.length / rowsToShow);
  ...
  const slicedOfficer = Officer.slice(startIndex, endIndex);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>Officer </h4></div>
                  ...
                  <div className="btn-box col-xl-3">
                    <a href="/adminofficerform" className="btn btn-primary"><i className="fa-light fa-plus"></i> Add New</a>
                  </div>
                </form>
                  ...
                  <table className="table table-striped">
                    <thead className='table-primary'>
                      <tr>
                        ...
                        <th scope="col">Service Type in marathi</th>
                        ...
                        <th scope="col">Special Unit</th>
                        <th scope="col">Police Station</th>
                        <th scope="col">Women Help Desk</th>
                    ...
                    <tbody>
                      ...
                      {slicedOfficer.map((item, index) => (
                        <tr key={index}>
                          ...
                          <td>{item.serviceTypeInMarathi}</td>
                          ...
                          <td>{item.specialUnit}</td>
                          <td>{item.policeStation}</td>
                          <td>{item.womenhelpdesk}</td>
                  ...
                  <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true"  style={{ display: modalOpen ? 'block' : 'none' }}>
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLabel">officer</h5>
