...
const AdminPressReleaseForm = () => {
  ...
  useEffect(() => {
    if (pressreleaseToUpdate) {
      setFormData({
        title: pressreleaseToUpdate.title || '',
        titleInMarathi: pressreleaseToUpdate.titleInMarathi || '',
        date: pressreleaseToUpdate.date || '',
        file: pressreleaseToUpdate.file || null,
        createdAt: pressreleaseToUpdate.createdAt || '',
        updatedAt: pressreleaseToUpdate.updatedAt || '',
      });
    }
          ...
          <div className=" col-md-10 col-xl-10 col-sm-10  justify-content-center pe-0 ps-0">
            ...
            <div className="row p-3 ">
              <div className="col-xl-12 bg-light rounded">
                <a href="/adminpressrelease" className="text-decoration-none text-dark">
                  {' '}
                  <h3 className="m-3">
                    {' '}
