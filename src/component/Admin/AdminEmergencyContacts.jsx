...
const AdminEmergencyContacts = () => {
  ...
  const handleUpdate = (item) => {
    navigate('/adminemergencycontactsform', { state: { contactToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(Contact.length / rowsToShow);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>Contact </h4></div>
                  ...
                  <table className="table table-striped ">
                    <thead className='table-primary'>
                      <tr>
                        ...
                        <th scope="col">Office/Unit Name</th>
                        <th scope="col">Office/Unit Name In Marathi</th>
                        <th scope="col">Officer's Name</th>
                        <th scope="col">Officer's Name In Marathi</th>
                    ...
                    <tbody>
                      <tr></tr>
                      {slicedContact.map((item, index) => (
                        <tr key={index}>
                          <td>{index + 1}</td>
                          <td>{item.officeUnitName}</td>
                          <td>{item.officeUnitNameMarathi}</td>
                          <td>{item.officersName}</td>
                          <td>{item.officersNameMarathi}</td>
                          <td>{item.number}</td>
                          <td>{item.whatsapp}</td>
                          <td>{item.email}</td>
