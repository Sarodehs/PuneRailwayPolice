...
const AdminSps = () => {
  ...
  const handleUpdate = (item) => {
    navigate('/adminspsform', { state: { spsToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(Sps.length / rowsToShow);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>Sps </h4></div>
                  ...
                  <div className="btn-box col-xl-3">
                    <a href="/adminspsform" className="btn btn-primary"><i className="fa-light fa-plus"></i> Add New</a>
                  </div>
                </form>
