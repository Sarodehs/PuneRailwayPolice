...
const AdminHeadline = () => {
  ...
  const handleUpdate = (item) => {
    navigate('/adminheadlineform', { state: { headlineToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(Headline.length / rowsToShow);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>Headline </h4></div>
