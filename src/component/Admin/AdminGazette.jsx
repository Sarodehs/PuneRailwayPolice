...
const AdminGazette = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/gazette/${id}`, {
        method: 'DELETE',
      });
      if (response.ok) {
  ...
  const handleUpdate = (item) => {
    navigate('/admingazetteform', { state: { gazetteToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(Gazette.length / rowsToShow);
  ...
  const slicedGazette = Gazette.slice(startIndex, endIndex);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>Gazette </h4></div>
                  ...
                  <div className="btn-box col-xl-3">
                    <a href="/admingazetteform" className="btn btn-primary"><i className="fa-light fa-plus"></i> Add New</a>
                  </div>
                </form>
