...
const AdminRtirementListForm = () => {
  ...
  useEffect(() => {
    if (rtirementlistToUpdate) {
      setFormData({
        name: rtirementlistToUpdate.name || '',
        nameinmarathi: rtirementlistToUpdate.nameinmarathi || '',
        message: rtirementlistToUpdate.message || '',
        FromDate: rtirementlistToUpdate.FromDate || '',
        ToDate: rtirementlistToUpdate.ToDate || '',
      });
    }
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      if (rtirementlistToUpdate) {
        ...
        url = `http://localhost:5000/rtirementlist/${rtirementlistToUpdate._id}`;
        method = 'PUT';
        action = 'updated';
      } else {
        // If rtirementlistToUpdate doesn't exist, create a new entry (POST request)
        url = 'http://localhost:5000/rtirementlist';
        method = 'POST';
        action = 'created';
      }
        ...
        <div className="row">
          ...
          <div className=" col-md-10 col-xl-10 col-sm-10  justify-content-center pe-0 ps-0" >
            ...
            <div className="row p-3 ">
              ...
              <a href="/adminrtirementlist" className="text-decoration-none text-dark"> <h3 className='m-3'> <span className="material-icons-outlined pe-3 p-2">arrow_back</span>
                  RtirementList</h3>
                  </a>
                <hr />
