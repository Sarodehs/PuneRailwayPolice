...
const AdminCrimeStatics = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/crimeStatistics/${id}`, {
        method: 'DELETE',
      });
      if (response.ok) {
  ...
  const handleUpdate = (item) => {
    navigate('/admincrimestaticsform', { state: { crimestaticsToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(CrimeStatics.length / rowsToShow);
  ...
  const slicedCrimeStatics = CrimeStatics.slice(startIndex, endIndex);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>CrimeStatics </h4></div>
                  ...
                  <div className="btn-box col-xl-3">
                    <a href="/admincrimestaticsform" className="btn btn-primary"><i className="fa-light fa-plus"></i> Add New</a>
                  </div>
                </form>
                <div className="card-body admintablesroll">
                  <table className="table table-striped">
                    ...
                    <tbody>
                      <tr></tr>
                      {slicedCrimeStatics.map((item, index) => (
                        <tr key={index}>
                          <td>{index + 1}</td>
                          <td>{item.title}</td>
...
export default AdminCrimeStatics