...
const AdminCitizensAlert = () => {
  ...
  const handleUpdate = (item) => {
    navigate('/admincitizensalertform', { state: { citizensalertToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(CitizensAlert.length / rowsToShow);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>Citizens Alert </h4></div>
                  ...
                  <div className="btn-box col-xl-3">
                    <a href="/admincitizensalertform" className="btn btn-primary"><i className="fa-light fa-plus"></i> Add New</a>
                  </div>
                </form>
                <div className="card-body">
                  <table className="table table-striped">
                    ...
                    <tbody>
                      <tr></tr>
                      {slicedCitizensAlert.map((item, index) => (
                        <tr key={index}>
                          <td>{index + 1}</td>
                          <td>{item.title}</td>
