...
const AdminPoliceStation = () => {
  ...
  const handleUpdate = (item) => {
    navigate('/adminpolicestationform', { state: { policestationToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(PoliceStation.length / rowsToShow);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>PoliceStation </h4></div>
                ...
                <div className="card-body">
                  <table className="table table-striped">
                    ...
                    <tbody>
                      <tr></tr>
                      {slicedPoliceStation.map((item, index) => (
                        <tr key={index}>
                          <td>{index + 1}</td>
                          <td>{item.name}</td>
...
export default AdminPoliceStation
