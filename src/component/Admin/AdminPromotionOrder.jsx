...
const AdminPromotionOrder = () => {
  ...
  const handleUpdate = (item) => {
    navigate('/adminpromotionorderform', { state: { promotionorderToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(PromotionOrder.length / rowsToShow);
  ...
  const slicedPromotionOrder = PromotionOrder.slice(startIndex, endIndex);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>PromotionOrder </h4></div>
...
export default AdminPromotionOrder
