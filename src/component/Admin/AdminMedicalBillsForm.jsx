        ...
        <div className="row">
          ...
          <div className=" col-md-10 col-xl-10 col-sm-10  justify-content-center pe-0 ps-0" >
            ...
            <div className="row p-3 ">
              ...
              <a href="/adminmedicalbills" className="text-decoration-none text-dark"> <h3 className='m-3'> <span className="material-icons-outlined pe-3 p-2">arrow_back</span>
                  MedicalBills</h3>
                  </a>
                <hr />
...
export default AdminMedicalBillsForm