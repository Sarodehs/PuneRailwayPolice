...
const AdminWomenCityTypes = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/womenCityType/${id}`, {
        method: 'DELETE',
      });
      if (response.ok) {
  ...
  const handleUpdate = (item) => {
    navigate('/adminwomencitytypesform', { state: { womencitytypesToUpdate: item } });
  };
  ...
  const totalPages = Math.ceil(WomenCityTypes.length / rowsToShow);
  ...
  const slicedWomenCityTypes = WomenCityTypes.slice(startIndex, endIndex);
            ...
            <div className="col-xl-12">
              <div className="card ">
                ...
                <form className="d-flex row m-3 align-items-center">
                  <div className="col-xl-3"> <h4>WomenCityTypes </h4></div>
                  ...
                  <div className="btn-box col-xl-3">
                    <a href="/adminwomencitytypesform" className="btn btn-primary"><i className="fa-light fa-plus"></i> Add New</a>
                  </div>
                </form>
                  ...
                  <table className="table table-striped">
                    <thead className='table-primary'>
                      <tr>
                        ...
                        <th scope="col">City Title</th>
                        <th scope="col">City Title In Marathi</th>
                    ...
                    <tbody>
                      <tr></tr>
                      {slicedWomenCityTypes.map((item, index) => (
                        <tr key={index}>
                          <td>{index + 1}</td>
                          <td>{item.cityTitle}</td>
                          <td>{item.cityTitleInMarathi}</td>
...
export default AdminWomenCityTypes
