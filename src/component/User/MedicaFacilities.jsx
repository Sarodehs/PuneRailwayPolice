...
const MedicalBills = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const medicalBillsDataWithAbsoluteUrls = data.map(item => ({
            ...item,
  ...
  const filteredData = medicalBillsData.filter(item =>
  ...
  const handleSearchSubmit = () => {
    const foundItems = medicalBillsData.filter(item =>
      item.title.toLowerCase().includes(searchQuery.toLowerCase())
    );
                    ...
                    <div className="modal-dialog">
                      <div className="modal-content">
                        <div className="modal-header">
                          <h5 className="modal-title">Medical Bills</h5>
                          <button
                            type="button"
                            className="btn-close"
                            onClick={closeModal}
